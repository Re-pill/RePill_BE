...
public enum ErrorStatus implements BaseErrorCode {
    ...
    // 약품 타입 관련 에러
    MEDICINE_TYPE_NOT_FOUND(HttpStatus.NOT_FOUND, "MEDICINE_TYPE404", "존재하지 않는 약품 타입입니다."),

    // 약품 관련 에러
    INSUFFICIENT_MEDICINE_COUNT(HttpStatus.BAD_REQUEST, "MEDICINE400", "폐기하려는 약품의 수량이 부족합니다."),
    MEDICINE_ALREADY_DISCARDED(HttpStatus.BAD_REQUEST, "MEDICINE409", "이미 폐기된 약품입니다."),
    ...
    MEDICINE_NOT_FOUND(HttpStatus.BAD_REQUEST, "MEDICINE404", "존재하지 않는 약입니다."),

    // 폐기 기록 관련 에러
    DISCARD_RECORD_NOT_FOUND(HttpStatus.NOT_FOUND, "RECORD404", "존재하지 않는 폐기 기록입니다."),
